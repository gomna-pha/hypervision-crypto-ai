var Pt=Object.defineProperty;var Xe=e=>{throw TypeError(e)};var Bt=(e,t,a)=>t in e?Pt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var x=(e,t,a)=>Bt(e,typeof t!="symbol"?t+"":t,a),qe=(e,t,a)=>t.has(e)||Xe("Cannot "+a);var u=(e,t,a)=>(qe(e,t,"read from private field"),a?a.call(e):t.get(e)),_=(e,t,a)=>t.has(e)?Xe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),y=(e,t,a,s)=>(qe(e,t,"write to private field"),s?s.call(e,a):t.set(e,a),a),S=(e,t,a)=>(qe(e,t,"access private method"),a);var Qe=(e,t,a,s)=>({set _(n){y(e,t,n,a)},get _(){return u(e,t,s)}});var Je=(e,t,a)=>(s,n)=>{let r=-1;return i(0);async function i(o){if(o<=r)throw new Error("next() called multiple times");r=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],s.req.routeIndex=o):d=o===e.length&&n||void 0,d)try{l=await d(s,()=>i(o+1))}catch(g){if(g instanceof Error&&t)s.error=g,l=await t(g,s),c=!0;else throw g}else s.finalized===!1&&a&&(l=await a(s));return l&&(s.finalized===!1||c)&&(s.res=l),s}},Nt=Symbol(),Ft=async(e,t=Object.create(null))=>{const{all:a=!1,dot:s=!1}=t,r=(e instanceof yt?e.raw.headers:e.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?jt(e,{all:a,dot:s}):{}};async function jt(e,t){const a=await e.formData();return a?$t(a,t):{}}function $t(e,t){const a=Object.create(null);return e.forEach((s,n)=>{t.all||n.endsWith("[]")?Ht(a,n,s):a[n]=s}),t.dot&&Object.entries(a).forEach(([s,n])=>{s.includes(".")&&(qt(a,s,n),delete a[s])}),a}var Ht=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},qt=(e,t,a)=>{let s=e;const n=t.split(".");n.forEach((r,i)=>{i===n.length-1?s[r]=a:((!s[r]||typeof s[r]!="object"||Array.isArray(s[r])||s[r]instanceof File)&&(s[r]=Object.create(null)),s=s[r])})},mt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Ut=e=>{const{groups:t,path:a}=Gt(e),s=mt(a);return zt(s,t)},Gt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,s)=>{const n=`@${s}`;return t.push([n,a]),n}),{groups:t,path:e}},zt=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[s]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,t[a][1]);break}}return e},Le={},Kt=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const s=`${e}#${t}`;return Le[s]||(a[2]?Le[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Le[s]=[e,a[1],!0]),Le[s]}return null},Ve=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Yt=e=>Ve(e,decodeURI),pt=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let s=a;for(;s<t.length;s++){const n=t.charCodeAt(s);if(n===37){const r=t.indexOf("?",s),i=t.slice(a,r===-1?void 0:r);return Yt(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(n===63)break}return t.slice(a,s)},Vt=e=>{const t=pt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},pe=(e,t,...a)=>(a.length&&(t=pe(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ft=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let s="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&s===""?a.push("/"):a.push(s);const r=n.replace("?","");s+="/"+r,a.push(s)}else s+="/"+n}),a.filter((n,r,i)=>i.indexOf(n)===r)},Ue=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ve(e,bt):e):e,ht=(e,t,a)=>{let s;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf(`?${t}`,8);for(i===-1&&(i=e.indexOf(`&${t}`,8));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return Ue(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let r=e.indexOf("?",8);for(;r!==-1;){const i=e.indexOf("&",r+1);let o=e.indexOf("=",r);o>i&&i!==-1&&(o=-1);let l=e.slice(r+1,o===-1?i===-1?void 0:i:o);if(s&&(l=Ue(l)),r=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),s&&(c=Ue(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},Wt=ht,Xt=(e,t)=>ht(e,t,!0),bt=decodeURIComponent,Ze=e=>Ve(e,bt),be,N,Q,xt,vt,ze,J,nt,yt=(nt=class{constructor(e,t="/",a=[[]]){_(this,Q);x(this,"raw");_(this,be);_(this,N);x(this,"routeIndex",0);x(this,"path");x(this,"bodyCache",{});_(this,J,e=>{const{bodyCache:t,raw:a}=this,s=t[e];if(s)return s;const n=Object.keys(t)[0];return n?t[n].then(r=>(n==="json"&&(r=JSON.stringify(r)),new Response(r)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,y(this,N,a),y(this,be,{})}param(e){return e?S(this,Q,xt).call(this,e):S(this,Q,vt).call(this)}query(e){return Wt(this.url,e)}queries(e){return Xt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,s)=>{t[s]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Ft(this,e))}json(){return u(this,J).call(this,"text").then(e=>JSON.parse(e))}text(){return u(this,J).call(this,"text")}arrayBuffer(){return u(this,J).call(this,"arrayBuffer")}blob(){return u(this,J).call(this,"blob")}formData(){return u(this,J).call(this,"formData")}addValidatedData(e,t){u(this,be)[e]=t}valid(e){return u(this,be)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Nt](){return u(this,N)}get matchedRoutes(){return u(this,N)[0].map(([[,e]])=>e)}get routePath(){return u(this,N)[0].map(([[,e]])=>e)[this.routeIndex].path}},be=new WeakMap,N=new WeakMap,Q=new WeakSet,xt=function(e){const t=u(this,N)[0][this.routeIndex][1][e],a=S(this,Q,ze).call(this,t);return a&&/\%/.test(a)?Ze(a):a},vt=function(){const e={},t=Object.keys(u(this,N)[0][this.routeIndex][1]);for(const a of t){const s=S(this,Q,ze).call(this,u(this,N)[0][this.routeIndex][1][a]);s!==void 0&&(e[a]=/\%/.test(s)?Ze(s):s)}return e},ze=function(e){return u(this,N)[1]?u(this,N)[1][e]:e},J=new WeakMap,nt),Qt={Stringify:1},_t=async(e,t,a,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const r=e.callbacks;return r!=null&&r.length?(n?n[0]+=e:n=[e],Promise.all(r.map(o=>o({phase:t,buffer:n,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(l=>_t(l,t,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},Jt="text/plain; charset=UTF-8",Ge=(e,t)=>({"Content-Type":e,...t}),Ce,Te,Y,ye,V,M,Ie,xe,ve,le,Re,De,Z,fe,rt,Zt=(rt=class{constructor(e,t){_(this,Z);_(this,Ce);_(this,Te);x(this,"env",{});_(this,Y);x(this,"finalized",!1);x(this,"error");_(this,ye);_(this,V);_(this,M);_(this,Ie);_(this,xe);_(this,ve);_(this,le);_(this,Re);_(this,De);x(this,"render",(...e)=>(u(this,xe)??y(this,xe,t=>this.html(t)),u(this,xe).call(this,...e)));x(this,"setLayout",e=>y(this,Ie,e));x(this,"getLayout",()=>u(this,Ie));x(this,"setRenderer",e=>{y(this,xe,e)});x(this,"header",(e,t,a)=>{this.finalized&&y(this,M,new Response(u(this,M).body,u(this,M)));const s=u(this,M)?u(this,M).headers:u(this,le)??y(this,le,new Headers);t===void 0?s.delete(e):a!=null&&a.append?s.append(e,t):s.set(e,t)});x(this,"status",e=>{y(this,ye,e)});x(this,"set",(e,t)=>{u(this,Y)??y(this,Y,new Map),u(this,Y).set(e,t)});x(this,"get",e=>u(this,Y)?u(this,Y).get(e):void 0);x(this,"newResponse",(...e)=>S(this,Z,fe).call(this,...e));x(this,"body",(e,t,a)=>S(this,Z,fe).call(this,e,t,a));x(this,"text",(e,t,a)=>!u(this,le)&&!u(this,ye)&&!t&&!a&&!this.finalized?new Response(e):S(this,Z,fe).call(this,e,t,Ge(Jt,a)));x(this,"json",(e,t,a)=>S(this,Z,fe).call(this,JSON.stringify(e),t,Ge("application/json",a)));x(this,"html",(e,t,a)=>{const s=n=>S(this,Z,fe).call(this,n,t,Ge("text/html; charset=UTF-8",a));return typeof e=="object"?_t(e,Qt.Stringify,!1,{}).then(s):s(e)});x(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});x(this,"notFound",()=>(u(this,ve)??y(this,ve,()=>new Response),u(this,ve).call(this,this)));y(this,Ce,e),t&&(y(this,V,t.executionCtx),this.env=t.env,y(this,ve,t.notFoundHandler),y(this,De,t.path),y(this,Re,t.matchResult))}get req(){return u(this,Te)??y(this,Te,new yt(u(this,Ce),u(this,De),u(this,Re))),u(this,Te)}get event(){if(u(this,V)&&"respondWith"in u(this,V))return u(this,V);throw Error("This context has no FetchEvent")}get executionCtx(){if(u(this,V))return u(this,V);throw Error("This context has no ExecutionContext")}get res(){return u(this,M)||y(this,M,new Response(null,{headers:u(this,le)??y(this,le,new Headers)}))}set res(e){if(u(this,M)&&e){e=new Response(e.body,e);for(const[t,a]of u(this,M).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=u(this,M).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}y(this,M,e),this.finalized=!0}get var(){return u(this,Y)?Object.fromEntries(u(this,Y)):{}}},Ce=new WeakMap,Te=new WeakMap,Y=new WeakMap,ye=new WeakMap,V=new WeakMap,M=new WeakMap,Ie=new WeakMap,xe=new WeakMap,ve=new WeakMap,le=new WeakMap,Re=new WeakMap,De=new WeakMap,Z=new WeakSet,fe=function(e,t,a){const s=u(this,M)?new Headers(u(this,M).headers):u(this,le)??new Headers;if(typeof t=="object"&&"headers"in t){const r=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of r)i.toLowerCase()==="set-cookie"?s.append(i,o):s.set(i,o)}if(a)for(const[r,i]of Object.entries(a))if(typeof i=="string")s.set(r,i);else{s.delete(r);for(const o of i)s.append(r,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??u(this,ye);return new Response(e,{status:n,headers:s})},rt),T="ALL",ea="all",ta=["get","post","put","delete","options","patch"],wt="Can not add a route since the matcher is already built.",St=class extends Error{},aa="__COMPOSED_HANDLER",sa=e=>e.text("404 Not Found",404),et=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},$,I,At,H,ie,Oe,Pe,it,Et=(it=class{constructor(t={}){_(this,I);x(this,"get");x(this,"post");x(this,"put");x(this,"delete");x(this,"options");x(this,"patch");x(this,"all");x(this,"on");x(this,"use");x(this,"router");x(this,"getPath");x(this,"_basePath","/");_(this,$,"/");x(this,"routes",[]);_(this,H,sa);x(this,"errorHandler",et);x(this,"onError",t=>(this.errorHandler=t,this));x(this,"notFound",t=>(y(this,H,t),this));x(this,"fetch",(t,...a)=>S(this,I,Pe).call(this,t,a[1],a[0],t.method));x(this,"request",(t,a,s,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,s,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${pe("/",t)}`,a),s,n)));x(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(S(this,I,Pe).call(this,t.request,t,void 0,t.request.method))})});[...ta,ea].forEach(r=>{this[r]=(i,...o)=>(typeof i=="string"?y(this,$,i):S(this,I,ie).call(this,r,u(this,$),i),o.forEach(l=>{S(this,I,ie).call(this,r,u(this,$),l)}),this)}),this.on=(r,i,...o)=>{for(const l of[i].flat()){y(this,$,l);for(const c of[r].flat())o.map(d=>{S(this,I,ie).call(this,c.toUpperCase(),u(this,$),d)})}return this},this.use=(r,...i)=>(typeof r=="string"?y(this,$,r):(y(this,$,"*"),i.unshift(r)),i.forEach(o=>{S(this,I,ie).call(this,T,u(this,$),o)}),this);const{strict:s,...n}=t;Object.assign(this,n),this.getPath=s??!0?t.getPath??pt:Vt}route(t,a){const s=this.basePath(t);return a.routes.map(n=>{var i;let r;a.errorHandler===et?r=n.handler:(r=async(o,l)=>(await Je([],a.errorHandler)(o,()=>n.handler(o,l))).res,r[aa]=n.handler),S(i=s,I,ie).call(i,n.method,n.path,r)}),this}basePath(t){const a=S(this,I,At).call(this);return a._basePath=pe(this._basePath,t),a}mount(t,a,s){let n,r;s&&(typeof s=="function"?r=s:(r=s.optionHandler,s.replaceRequest===!1?n=l=>l:n=s.replaceRequest));const i=r?l=>{const c=r(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=pe(this._basePath,t),c=l==="/"?0:l.length;return d=>{const g=new URL(d.url);return g.pathname=g.pathname.slice(c)||"/",new Request(g,d)}})());const o=async(l,c)=>{const d=await a(n(l.req.raw),...i(l));if(d)return d;await c()};return S(this,I,ie).call(this,T,pe(t,"*"),o),this}},$=new WeakMap,I=new WeakSet,At=function(){const t=new Et({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,y(t,H,u(this,H)),t.routes=this.routes,t},H=new WeakMap,ie=function(t,a,s){t=t.toUpperCase(),a=pe(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:s};this.router.add(t,a,[s,n]),this.routes.push(n)},Oe=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},Pe=function(t,a,s,n){if(n==="HEAD")return(async()=>new Response(null,await S(this,I,Pe).call(this,t,a,s,"GET")))();const r=this.getPath(t,{env:s}),i=this.router.match(n,r),o=new Zt(t,{path:r,matchResult:i,env:s,executionCtx:a,notFoundHandler:u(this,H)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await u(this,H).call(this,o)})}catch(d){return S(this,I,Oe).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:u(this,H).call(this,o))).catch(d=>S(this,I,Oe).call(this,d,o)):c??u(this,H).call(this,o)}const l=Je(i[0],this.errorHandler,u(this,H));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return S(this,I,Oe).call(this,c,o)}})()},it),Ct=[];function na(e,t){const a=this.buildAllMatchers(),s=(n,r)=>{const i=a[n]||a[T],o=i[2][r];if(o)return o;const l=r.match(i[0]);if(!l)return[[],Ct];const c=l.indexOf("",1);return[i[1][c],l]};return this.match=s,s(e,t)}var Ne="[^/]+",Ee=".*",Ae="(?:|/.*)",he=Symbol(),ra=new Set(".\\+*[^]$()");function ia(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ee||e===Ae?1:t===Ee||t===Ae?-1:e===Ne?1:t===Ne?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var ce,de,q,ot,Ke=(ot=class{constructor(){_(this,ce);_(this,de);_(this,q,Object.create(null))}insert(t,a,s,n,r){if(t.length===0){if(u(this,ce)!==void 0)throw he;if(r)return;y(this,ce,a);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",Ee]:["","",Ne]:i==="/*"?["","",Ae]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let g=l[2]||Ne;if(d&&l[2]&&(g===".*"||(g=g.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(g))))throw he;if(c=u(this,q)[g],!c){if(Object.keys(u(this,q)).some(m=>m!==Ee&&m!==Ae))throw he;if(r)return;c=u(this,q)[g]=new Ke,d!==""&&y(c,de,n.varIndex++)}!r&&d!==""&&s.push([d,u(c,de)])}else if(c=u(this,q)[i],!c){if(Object.keys(u(this,q)).some(d=>d.length>1&&d!==Ee&&d!==Ae))throw he;if(r)return;c=u(this,q)[i]=new Ke}c.insert(o,a,s,n,r)}buildRegExpStr(){const a=Object.keys(u(this,q)).sort(ia).map(s=>{const n=u(this,q)[s];return(typeof u(n,de)=="number"?`(${s})@${u(n,de)}`:ra.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof u(this,ce)=="number"&&a.unshift(`#${u(this,ce)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},ce=new WeakMap,de=new WeakMap,q=new WeakMap,ot),je,ke,lt,oa=(lt=class{constructor(){_(this,je,{varIndex:0});_(this,ke,new Ke)}insert(e,t,a){const s=[],n=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return n[i]=[c,l],i++,o=!0,c}),!o)break}const r=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[o]=n[i];for(let l=r.length-1;l>=0;l--)if(r[l].indexOf(o)!==-1){r[l]=r[l].replace(o,n[i][1]);break}}return u(this,ke).insert(r,t,s,u(this,je),a),s}buildRegExp(){let e=u(this,ke).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,r,i)=>r!==void 0?(a[++t]=Number(r),"$()"):(i!==void 0&&(s[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,s]}},je=new WeakMap,ke=new WeakMap,lt),la=[/^$/,[],Object.create(null)],Be=Object.create(null);function Tt(e){return Be[e]??(Be[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function ca(){Be=Object.create(null)}function da(e){var c;const t=new oa,a=[];if(e.length===0)return la;const s=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,g],[m,p])=>d?1:m?-1:g.length-p.length),n=Object.create(null);for(let d=0,g=-1,m=s.length;d<m;d++){const[p,v,f]=s[d];p?n[v]=[f.map(([w])=>[w,Object.create(null)]),Ct]:g++;let b;try{b=t.insert(v,g,p)}catch(w){throw w===he?new St(v):w}p||(a[g]=f.map(([w,A])=>{const O=Object.create(null);for(A-=1;A>=0;A--){const[R,F]=b[A];O[R]=F}return[w,O]}))}const[r,i,o]=t.buildRegExp();for(let d=0,g=a.length;d<g;d++)for(let m=0,p=a[d].length;m<p;m++){const v=(c=a[d][m])==null?void 0:c[1];if(!v)continue;const f=Object.keys(v);for(let b=0,w=f.length;b<w;b++)v[f[b]]=o[v[f[b]]]}const l=[];for(const d in i)l[d]=a[i[d]];return[r,l,n]}function me(e,t){if(e){for(const a of Object.keys(e).sort((s,n)=>n.length-s.length))if(Tt(a).test(t))return[...e[a]]}}var ee,te,$e,It,ct,ua=(ct=class{constructor(){_(this,$e);x(this,"name","RegExpRouter");_(this,ee);_(this,te);x(this,"match",na);y(this,ee,{[T]:Object.create(null)}),y(this,te,{[T]:Object.create(null)})}add(e,t,a){var o;const s=u(this,ee),n=u(this,te);if(!s||!n)throw new Error(wt);s[e]||[s,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[T]).forEach(c=>{l[e][c]=[...l[T][c]]})}),t==="/*"&&(t="*");const r=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Tt(t);e===T?Object.keys(s).forEach(c=>{var d;(d=s[c])[t]||(d[t]=me(s[c],t)||me(s[T],t)||[])}):(o=s[e])[t]||(o[t]=me(s[e],t)||me(s[T],t)||[]),Object.keys(s).forEach(c=>{(e===T||e===c)&&Object.keys(s[c]).forEach(d=>{l.test(d)&&s[c][d].push([a,r])})}),Object.keys(n).forEach(c=>{(e===T||e===c)&&Object.keys(n[c]).forEach(d=>l.test(d)&&n[c][d].push([a,r]))});return}const i=ft(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(n).forEach(g=>{var m;(e===T||e===g)&&((m=n[g])[d]||(m[d]=[...me(s[g],d)||me(s[T],d)||[]]),n[g][d].push([a,r-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(u(this,te)).concat(Object.keys(u(this,ee))).forEach(t=>{e[t]||(e[t]=S(this,$e,It).call(this,t))}),y(this,ee,y(this,te,void 0)),ca(),e}},ee=new WeakMap,te=new WeakMap,$e=new WeakSet,It=function(e){const t=[];let a=e===T;return[u(this,ee),u(this,te)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(r=>[r,s[e][r]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==T&&t.push(...Object.keys(s[T]).map(r=>[r,s[T][r]]))}),a?da(t):null},ct),ae,W,dt,ga=(dt=class{constructor(e){x(this,"name","SmartRouter");_(this,ae,[]);_(this,W,[]);y(this,ae,e.routers)}add(e,t,a){if(!u(this,W))throw new Error(wt);u(this,W).push([e,t,a])}match(e,t){if(!u(this,W))throw new Error("Fatal error");const a=u(this,ae),s=u(this,W),n=a.length;let r=0,i;for(;r<n;r++){const o=a[r];try{for(let l=0,c=s.length;l<c;l++)o.add(...s[l]);i=o.match(e,t)}catch(l){if(l instanceof St)continue;throw l}this.match=o.match.bind(o),y(this,ae,[o]),y(this,W,void 0);break}if(r===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(u(this,W)||u(this,ae).length!==1)throw new Error("No active router has been determined yet.");return u(this,ae)[0]}},ae=new WeakMap,W=new WeakMap,dt),Se=Object.create(null),se,k,ue,_e,D,X,oe,ut,Rt=(ut=class{constructor(e,t,a){_(this,X);_(this,se);_(this,k);_(this,ue);_(this,_e,0);_(this,D,Se);if(y(this,k,a||Object.create(null)),y(this,se,[]),e&&t){const s=Object.create(null);s[e]={handler:t,possibleKeys:[],score:0},y(this,se,[s])}y(this,ue,[])}insert(e,t,a){y(this,_e,++Qe(this,_e)._);let s=this;const n=Ut(t),r=[];for(let i=0,o=n.length;i<o;i++){const l=n[i],c=n[i+1],d=Kt(l,c),g=Array.isArray(d)?d[0]:l;if(g in u(s,k)){s=u(s,k)[g],d&&r.push(d[1]);continue}u(s,k)[g]=new Rt,d&&(u(s,ue).push(d),r.push(d[1])),s=u(s,k)[g]}return u(s,se).push({[e]:{handler:a,possibleKeys:r.filter((i,o,l)=>l.indexOf(i)===o),score:u(this,_e)}}),s}search(e,t){var o;const a=[];y(this,D,Se);let n=[this];const r=mt(t),i=[];for(let l=0,c=r.length;l<c;l++){const d=r[l],g=l===c-1,m=[];for(let p=0,v=n.length;p<v;p++){const f=n[p],b=u(f,k)[d];b&&(y(b,D,u(f,D)),g?(u(b,k)["*"]&&a.push(...S(this,X,oe).call(this,u(b,k)["*"],e,u(f,D))),a.push(...S(this,X,oe).call(this,b,e,u(f,D)))):m.push(b));for(let w=0,A=u(f,ue).length;w<A;w++){const O=u(f,ue)[w],R=u(f,D)===Se?{}:{...u(f,D)};if(O==="*"){const P=u(f,k)["*"];P&&(a.push(...S(this,X,oe).call(this,P,e,u(f,D))),y(P,D,R),m.push(P));continue}const[F,G,L]=O;if(!d&&!(L instanceof RegExp))continue;const C=u(f,k)[F],ne=r.slice(l).join("/");if(L instanceof RegExp){const P=L.exec(ne);if(P){if(R[G]=P[0],a.push(...S(this,X,oe).call(this,C,e,u(f,D),R)),Object.keys(u(C,k)).length){y(C,D,R);const z=((o=P[0].match(/\//))==null?void 0:o.length)??0;(i[z]||(i[z]=[])).push(C)}continue}}(L===!0||L.test(d))&&(R[G]=d,g?(a.push(...S(this,X,oe).call(this,C,e,R,u(f,D))),u(C,k)["*"]&&a.push(...S(this,X,oe).call(this,u(C,k)["*"],e,R,u(f,D)))):(y(C,D,R),m.push(C)))}}n=m.concat(i.shift()??[])}return a.length>1&&a.sort((l,c)=>l.score-c.score),[a.map(({handler:l,params:c})=>[l,c])]}},se=new WeakMap,k=new WeakMap,ue=new WeakMap,_e=new WeakMap,D=new WeakMap,X=new WeakSet,oe=function(e,t,a,s){const n=[];for(let r=0,i=u(e,se).length;r<i;r++){const o=u(e,se)[r],l=o[t]||o[T],c={};if(l!==void 0&&(l.params=Object.create(null),n.push(l),a!==Se||s&&s!==Se))for(let d=0,g=l.possibleKeys.length;d<g;d++){const m=l.possibleKeys[d],p=c[l.score];l.params[m]=s!=null&&s[m]&&!p?s[m]:a[m]??(s==null?void 0:s[m]),c[l.score]=!0}}return n},ut),ge,gt,ma=(gt=class{constructor(){x(this,"name","TrieRouter");_(this,ge);y(this,ge,new Rt)}add(e,t,a){const s=ft(t);if(s){for(let n=0,r=s.length;n<r;n++)u(this,ge).insert(e,s[n],a);return}u(this,ge).insert(e,t,a)}match(e,t){return u(this,ge).search(e,t)}},ge=new WeakMap,gt),Dt=class extends Et{constructor(e={}){super(e),this.router=e.router??new ga({routers:[new ua,new ma]})}},pa=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(r=>typeof r=="string"?r==="*"?()=>r:i=>r===i?i:null:typeof r=="function"?r:i=>r.includes(i)?i:null)(a.origin),n=(r=>typeof r=="function"?r:Array.isArray(r)?()=>r:()=>[])(a.allowMethods);return async function(i,o){var d;function l(g,m){i.res.headers.set(g,m)}const c=await s(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(d=a.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const g=await n(i.req.header("origin")||"",i);g.length&&l("Access-Control-Allow-Methods",g.join(","));let m=a.allowHeaders;if(!(m!=null&&m.length)){const p=i.req.header("Access-Control-Request-Headers");p&&(m=p.split(/\s*,\s*/))}return m!=null&&m.length&&(l("Access-Control-Allow-Headers",m.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}},fa=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,tt=(e,t=ba)=>{const a=/\.([a-zA-Z0-9]+?)$/,s=e.match(a);if(!s)return;let n=t[s[1]];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},ha={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},ba=ha,ya=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const a=t.split("/"),s=[];for(const n of a)n===".."&&s.length>0&&s.at(-1)!==".."?s.pop():n!=="."&&s.push(n);return s.join("/")||"."},kt={br:".br",zstd:".zst",gzip:".gz"},xa=Object.keys(kt),va="index.html",_a=e=>{const t=e.root??"./",a=e.path,s=e.join??ya;return async(n,r)=>{var d,g,m,p;if(n.finalized)return r();let i;if(e.path)i=e.path;else try{if(i=decodeURIComponent(n.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(i))throw new Error}catch{return await((d=e.onNotFound)==null?void 0:d.call(e,n.req.path,n)),r()}let o=s(t,!a&&e.rewriteRequestPath?e.rewriteRequestPath(i):i);e.isDir&&await e.isDir(o)&&(o=s(o,va));const l=e.getContent;let c=await l(o,n);if(c instanceof Response)return n.newResponse(c.body,c);if(c){const v=e.mimes&&tt(o,e.mimes)||tt(o);if(n.header("Content-Type",v||"application/octet-stream"),e.precompressed&&(!v||fa.test(v))){const f=new Set((g=n.req.header("Accept-Encoding"))==null?void 0:g.split(",").map(b=>b.trim()));for(const b of xa){if(!f.has(b))continue;const w=await l(o+kt[b],n);if(w){c=w,n.header("Content-Encoding",b),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((m=e.onFound)==null?void 0:m.call(e,o,n)),n.body(c)}await((p=e.onNotFound)==null?void 0:p.call(e,o,n)),await r()}},wa=async(e,t)=>{let a;t&&t.manifest?typeof t.manifest=="string"?a=JSON.parse(t.manifest):a=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?a=JSON.parse(__STATIC_CONTENT_MANIFEST):a=__STATIC_CONTENT_MANIFEST;let s;t&&t.namespace?s=t.namespace:s=__STATIC_CONTENT;const n=a[e]||e;if(!n)return null;const r=await s.get(n,{type:"stream"});return r||null},Sa=e=>async function(a,s){return _a({...e,getContent:async r=>wa(r,{manifest:e.manifest,namespace:e.namespace?e.namespace:a.env?a.env.__STATIC_CONTENT:void 0})})(a,s)},Ea=e=>Sa(e);const E=new Dt,h={ECONOMIC:{FED_RATE_BULLISH:4.5,FED_RATE_BEARISH:5.5,CPI_TARGET:2,CPI_WARNING:3.5,GDP_HEALTHY:2,UNEMPLOYMENT_LOW:4,PMI_EXPANSION:50,TREASURY_SPREAD_INVERSION:-.5},SENTIMENT:{FEAR_GREED_EXTREME_FEAR:25,FEAR_GREED_EXTREME_GREED:75,VIX_LOW:15,VIX_HIGH:25,SOCIAL_VOLUME_HIGH:15e4,INSTITUTIONAL_FLOW_THRESHOLD:10},LIQUIDITY:{BID_ASK_SPREAD_TIGHT:.1,BID_ASK_SPREAD_WIDE:.5,ARBITRAGE_OPPORTUNITY:.3,ORDER_BOOK_DEPTH_MIN:1e6,SLIPPAGE_MAX:.2},TRENDS:{INTEREST_HIGH:70,INTEREST_RISING:20},IMF:{GDP_GROWTH_STRONG:3,INFLATION_TARGET:2.5,DEBT_WARNING:80}};E.use("/api/*",pa());E.use("/static/*",Ea({root:"./public"}));async function Aa(){try{const e=new AbortController,t=setTimeout(()=>e.abort(),5e3),a=await fetch("https://www.imf.org/external/datamapper/api/v1/NGDP_RPCH,PCPIPCH",{signal:e.signal});if(clearTimeout(t),!a.ok)return null;const s=await a.json();return{timestamp:Date.now(),iso_timestamp:new Date().toISOString(),gdp_growth:s.NGDP_RPCH||{},inflation:s.PCPIPCH||{},source:"IMF"}}catch(e){return console.error("IMF API error (timeout or network):",e),null}}async function Lt(e="BTCUSDT"){try{const t=await fetch(`https://api.binance.com/api/v3/ticker/24hr?symbol=${e}`);if(!t.ok)return null;const a=await t.json();return{exchange:"Binance",symbol:e,price:parseFloat(a.lastPrice),volume_24h:parseFloat(a.volume),price_change_24h:parseFloat(a.priceChangePercent),high_24h:parseFloat(a.highPrice),low_24h:parseFloat(a.lowPrice),bid:parseFloat(a.bidPrice),ask:parseFloat(a.askPrice),timestamp:a.closeTime}}catch(t){return console.error("Binance API error:",t),null}}async function Fe(e="BTC-USD"){try{const t=await fetch(`https://api.coinbase.com/v2/prices/${e}/spot`);if(!t.ok)return null;const a=await t.json();return{exchange:"Coinbase",symbol:e,price:parseFloat(a.data.amount),currency:a.data.currency,timestamp:Date.now()}}catch(t){return console.error("Coinbase API error:",t),null}}async function Mt(e="XBTUSD"){try{const t=await fetch(`https://api.kraken.com/0/public/Ticker?pair=${e}`);if(!t.ok)return null;const a=await t.json(),s=a.result[Object.keys(a.result)[0]];return{exchange:"Kraken",pair:e,price:parseFloat(s.c[0]),volume_24h:parseFloat(s.v[1]),bid:parseFloat(s.b[0]),ask:parseFloat(s.a[0]),high_24h:parseFloat(s.h[1]),low_24h:parseFloat(s.l[1]),timestamp:Date.now()}}catch(t){return console.error("Kraken API error:",t),null}}async function Ca(e,t="bitcoin"){var a,s,n,r;if(!e)return null;try{const i=await fetch(`https://api.coingecko.com/api/v3/simple/price?ids=${t}&vs_currencies=usd&include_24hr_change=true&include_24hr_vol=true&include_last_updated_at=true`,{headers:{"x-cg-demo-api-key":e}});if(!i.ok)return null;const o=await i.json();return{coin:t,price:(a=o[t])==null?void 0:a.usd,volume_24h:(s=o[t])==null?void 0:s.usd_24h_vol,change_24h:(n=o[t])==null?void 0:n.usd_24h_change,last_updated:(r=o[t])==null?void 0:r.last_updated_at,timestamp:Date.now(),source:"CoinGecko"}}catch(i){return console.error("CoinGecko API error:",i),null}}async function Me(e,t){if(!e)return null;try{const a=new AbortController,s=setTimeout(()=>a.abort(),5e3),n=await fetch(`https://api.stlouisfed.org/fred/series/observations?series_id=${t}&api_key=${e}&file_type=json&limit=1&sort_order=desc`,{signal:a.signal});if(clearTimeout(s),!n.ok)return null;const i=(await n.json()).observations[0];return{series_id:t,value:parseFloat(i.value),date:i.date,timestamp:Date.now(),source:"FRED"}}catch(a){return console.error("FRED API error:",a),null}}async function Ta(e,t){if(!e)return null;try{const a=new AbortController,s=setTimeout(()=>a.abort(),5e3),n=await fetch(`https://serpapi.com/search.json?engine=google_trends&q=${encodeURIComponent(t)}&api_key=${e}`,{signal:a.signal});if(clearTimeout(s),!n.ok)return null;const r=await n.json();return{query:t,interest_over_time:r.interest_over_time,timestamp:Date.now(),source:"Google Trends"}}catch(a){return console.error("Google Trends API error:",a),null}}function Ia(e){const t=[];for(let a=0;a<e.length;a++)for(let s=a+1;s<e.length;s++){const n=e[a],r=e[s];if(n&&r&&n.price&&r.price){const i=(r.price-n.price)/n.price*100;Math.abs(i)>=h.LIQUIDITY.ARBITRAGE_OPPORTUNITY&&t.push({buy_exchange:i>0?n.exchange:r.exchange,sell_exchange:i>0?r.exchange:n.exchange,spread_percent:Math.abs(i),profit_potential:Math.abs(i)>h.LIQUIDITY.ARBITRAGE_OPPORTUNITY?"high":"medium"})}}return t}E.get("/api/market/data/:symbol",async e=>{const t=e.req.param("symbol"),{env:a}=e;try{const s=Date.now();return await a.DB.prepare(`
      INSERT INTO market_data (symbol, exchange, price, volume, timestamp, data_type)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(t,"aggregated",0,0,s,"spot").run(),e.json({success:!0,data:{symbol:t,price:Math.random()*5e4+3e4,volume:Math.random()*1e6,timestamp:s,source:"mock"}})}catch(s){return e.json({success:!1,error:String(s)},500)}});E.get("/api/economic/indicators",async e=>{var a;const{env:t}=e;try{const s=await t.DB.prepare(`
      SELECT * FROM economic_indicators 
      ORDER BY timestamp DESC 
      LIMIT 10
    `).all();return e.json({success:!0,data:s.results,count:((a=s.results)==null?void 0:a.length)||0})}catch(s){return e.json({success:!1,error:String(s)},500)}});E.post("/api/economic/indicators",async e=>{const{env:t}=e,a=await e.req.json();try{const{indicator_name:s,indicator_code:n,value:r,period:i,source:o}=a,l=Date.now();return await t.DB.prepare(`
      INSERT INTO economic_indicators 
      (indicator_name, indicator_code, value, period, source, timestamp)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(s,n,r,i,o,l).run(),e.json({success:!0,message:"Indicator stored successfully"})}catch(s){return e.json({success:!1,error:String(s)},500)}});E.get("/api/agents/economic",async e=>{var s,n,r,i;const t=e.req.query("symbol")||"BTC",{env:a}=e;try{const o=a.FRED_API_KEY,l=await Promise.all([Me(o,"FEDFUNDS"),Me(o,"CPIAUCSL"),Me(o,"UNRATE"),Me(o,"GDP")]),c=await Aa(),d=((s=l[0])==null?void 0:s.value)||5.33,g=((n=l[1])==null?void 0:n.value)||3.2,m=((r=l[2])==null?void 0:r.value)||3.8,p=((i=l[3])==null?void 0:i.value)||2.4,v=d<h.ECONOMIC.FED_RATE_BULLISH?"bullish":d>h.ECONOMIC.FED_RATE_BEARISH?"bearish":"neutral",f=g<=h.ECONOMIC.CPI_TARGET?"healthy":g>h.ECONOMIC.CPI_WARNING?"warning":"elevated",b=p>=h.ECONOMIC.GDP_HEALTHY?"healthy":"weak",w=m<=h.ECONOMIC.UNEMPLOYMENT_LOW?"tight":"loose",A={timestamp:Date.now(),iso_timestamp:new Date().toISOString(),symbol:t,data_source:"Economic Agent",data_freshness:o?"LIVE":"SIMULATED",indicators:{fed_funds_rate:{value:d,signal:v,constraint_bullish:h.ECONOMIC.FED_RATE_BULLISH,constraint_bearish:h.ECONOMIC.FED_RATE_BEARISH,next_meeting:"2025-11-07",source:l[0]?"FRED":"simulated"},cpi:{value:g,signal:f,target:h.ECONOMIC.CPI_TARGET,warning_threshold:h.ECONOMIC.CPI_WARNING,trend:g<3.5?"decreasing":"elevated",source:l[1]?"FRED":"simulated"},unemployment_rate:{value:m,signal:w,threshold:h.ECONOMIC.UNEMPLOYMENT_LOW,trend:m<4?"tight":"stable",source:l[2]?"FRED":"simulated"},gdp_growth:{value:p,signal:b,healthy_threshold:h.ECONOMIC.GDP_HEALTHY,quarter:"Q3 2025",source:l[3]?"FRED":"simulated"},manufacturing_pmi:{value:48.5,status:48.5<h.ECONOMIC.PMI_EXPANSION?"contraction":"expansion",expansion_threshold:h.ECONOMIC.PMI_EXPANSION},imf_global:c?{available:!0,gdp_growth:c.gdp_growth,inflation:c.inflation,source:"IMF",timestamp:c.iso_timestamp}:{available:!1}},constraints_applied:{fed_rate_range:[h.ECONOMIC.FED_RATE_BULLISH,h.ECONOMIC.FED_RATE_BEARISH],cpi_target:h.ECONOMIC.CPI_TARGET,gdp_healthy:h.ECONOMIC.GDP_HEALTHY,unemployment_low:h.ECONOMIC.UNEMPLOYMENT_LOW}};return e.json({success:!0,agent:"economic",data:A})}catch(o){return e.json({success:!1,error:String(o)},500)}});E.get("/api/agents/sentiment",async e=>{const t=e.req.query("symbol")||"BTC",{env:a}=e;try{const s=a.SERPAPI_KEY,n=await Ta(s,t==="BTC"?"bitcoin":"ethereum"),r=61+Math.floor(Math.random()*20-10),i=19.98+Math.random()*4-2,o=1e5+Math.floor(Math.random()*2e4),l=-7+Math.random()*10-5,c=r<h.SENTIMENT.FEAR_GREED_EXTREME_FEAR?"extreme_fear":r>h.SENTIMENT.FEAR_GREED_EXTREME_GREED?"extreme_greed":"neutral",d=i<h.SENTIMENT.VIX_LOW?"low_volatility":i>h.SENTIMENT.VIX_HIGH?"high_volatility":"moderate",g=o>h.SENTIMENT.SOCIAL_VOLUME_HIGH?"high_activity":"normal",m=Math.abs(l)>h.SENTIMENT.INSTITUTIONAL_FLOW_THRESHOLD?"significant":"minor",p={timestamp:Date.now(),iso_timestamp:new Date().toISOString(),symbol:t,data_source:"Sentiment Agent",data_freshness:s?"LIVE":"SIMULATED",sentiment_metrics:{fear_greed_index:{value:r,signal:c,classification:c==="neutral"?"neutral":c,constraint_extreme_fear:h.SENTIMENT.FEAR_GREED_EXTREME_FEAR,constraint_extreme_greed:h.SENTIMENT.FEAR_GREED_EXTREME_GREED,interpretation:r<25?"Contrarian Buy Signal":r>75?"Contrarian Sell Signal":"Neutral"},volatility_index_vix:{value:i,signal:d,interpretation:d,constraint_low:h.SENTIMENT.VIX_LOW,constraint_high:h.SENTIMENT.VIX_HIGH},social_media_volume:{mentions:o,signal:g,trend:g==="high_activity"?"elevated":"average",constraint_high:h.SENTIMENT.SOCIAL_VOLUME_HIGH},institutional_flow_24h:{net_flow_million_usd:l,signal:m,direction:l>0?"inflow":"outflow",magnitude:Math.abs(l)>10?"strong":"moderate",constraint_threshold:h.SENTIMENT.INSTITUTIONAL_FLOW_THRESHOLD},google_trends:n?{available:!0,query:n.query,interest_data:n.interest_over_time,source:"Google Trends via SerpApi",timestamp:n.timestamp}:{available:!1,message:"Provide SERPAPI_KEY for live Google Trends data"}},constraints_applied:{fear_greed_range:[h.SENTIMENT.FEAR_GREED_EXTREME_FEAR,h.SENTIMENT.FEAR_GREED_EXTREME_GREED],vix_range:[h.SENTIMENT.VIX_LOW,h.SENTIMENT.VIX_HIGH],social_threshold:h.SENTIMENT.SOCIAL_VOLUME_HIGH,flow_threshold:h.SENTIMENT.INSTITUTIONAL_FLOW_THRESHOLD}};return e.json({success:!0,agent:"sentiment",data:p})}catch(s){return e.json({success:!1,error:String(s)},500)}});E.get("/api/agents/cross-exchange",async e=>{const t=e.req.query("symbol")||"BTC",{env:a}=e;try{const[s,n,r,i]=await Promise.all([Lt(t==="BTC"?"BTCUSDT":"ETHUSDT"),Fe(t==="BTC"?"BTC-USD":"ETH-USD"),Mt(t==="BTC"?"XBTUSD":"ETHUSD"),Ca(a.COINGECKO_API_KEY,t==="BTC"?"bitcoin":"ethereum")]),o=[s,n,r].filter(Boolean),l=Ia(o),c=o.map(f=>f&&f.bid&&f.ask?(f.ask-f.bid)/f.bid*100:0).filter(f=>f>0),d=c.length>0?c.reduce((f,b)=>f+b,0)/c.length:.1,g=d<h.LIQUIDITY.BID_ASK_SPREAD_TIGHT?"tight":d>h.LIQUIDITY.BID_ASK_SPREAD_WIDE?"wide":"moderate",m=d<h.LIQUIDITY.BID_ASK_SPREAD_TIGHT?"excellent":d<h.LIQUIDITY.BID_ASK_SPREAD_WIDE?"good":"poor",p=o.reduce((f,b)=>f+((b==null?void 0:b.volume_24h)||0),0),v={timestamp:Date.now(),iso_timestamp:new Date().toISOString(),symbol:t,data_source:"Cross-Exchange Agent",data_freshness:"LIVE",live_exchanges:{binance:s?{available:!0,price:s.price,volume_24h:s.volume_24h,spread:s.ask&&s.bid?((s.ask-s.bid)/s.bid*100).toFixed(3)+"%":"N/A",timestamp:new Date(s.timestamp).toISOString()}:{available:!1},coinbase:n?{available:!0,price:n.price,timestamp:new Date(n.timestamp).toISOString()}:{available:!1},kraken:r?{available:!0,price:r.price,volume_24h:r.volume_24h,spread:r.ask&&r.bid?((r.ask-r.bid)/r.bid*100).toFixed(3)+"%":"N/A",timestamp:new Date(r.timestamp).toISOString()}:{available:!1},coingecko:i?{available:!0,price:i.price,volume_24h:i.volume_24h,change_24h:i.change_24h,source:"CoinGecko API"}:{available:!1,message:"Provide COINGECKO_API_KEY for aggregated data"}},market_depth_analysis:{total_volume_24h:{usd:p,exchanges_reporting:o.length},liquidity_metrics:{average_spread_percent:d.toFixed(3),spread_signal:g,liquidity_quality:m,constraint_tight:h.LIQUIDITY.BID_ASK_SPREAD_TIGHT,constraint_wide:h.LIQUIDITY.BID_ASK_SPREAD_WIDE},arbitrage_opportunities:{count:l.length,opportunities:l,minimum_spread_threshold:h.LIQUIDITY.ARBITRAGE_OPPORTUNITY,analysis:l.length>0?"Profitable arbitrage detected":"No significant arbitrage"},execution_quality:{recommended_exchanges:o.map(f=>f==null?void 0:f.exchange).filter(Boolean),optimal_for_large_orders:s?"Binance":"N/A",slippage_estimate:d<.2?"low":"moderate"}},constraints_applied:{spread_tight:h.LIQUIDITY.BID_ASK_SPREAD_TIGHT,spread_wide:h.LIQUIDITY.BID_ASK_SPREAD_WIDE,arbitrage_min:h.LIQUIDITY.ARBITRAGE_OPPORTUNITY,depth_min:h.LIQUIDITY.ORDER_BOOK_DEPTH_MIN,slippage_max:h.LIQUIDITY.SLIPPAGE_MAX}};return e.json({success:!0,agent:"cross-exchange",data:v})}catch(s){return e.json({success:!1,error:String(s)},500)}});E.get("/api/status",async e=>{const{env:t}=e,a={timestamp:Date.now(),iso_timestamp:new Date().toISOString(),platform:"Trading Intelligence Platform",version:"2.0.0",environment:"production-ready",api_integrations:{imf:{status:"active",description:"IMF Global Economic Data",requires_key:!1,cost:"FREE",data_freshness:"live"},binance:{status:"active",description:"Binance Exchange Data",requires_key:!1,cost:"FREE",data_freshness:"live"},coinbase:{status:"active",description:"Coinbase Exchange Data",requires_key:!1,cost:"FREE",data_freshness:"live"},kraken:{status:"active",description:"Kraken Exchange Data",requires_key:!1,cost:"FREE",data_freshness:"live"},gemini_ai:{status:t.GEMINI_API_KEY?"active":"inactive",description:"Gemini AI Analysis",requires_key:!0,configured:!!t.GEMINI_API_KEY,cost:"~$5-10/month",data_freshness:t.GEMINI_API_KEY?"live":"unavailable"},coingecko:{status:t.COINGECKO_API_KEY?"active":"inactive",description:"CoinGecko Aggregated Crypto Data",requires_key:!0,configured:!!t.COINGECKO_API_KEY,cost:"FREE tier: 10 calls/min",data_freshness:t.COINGECKO_API_KEY?"live":"unavailable"},fred:{status:t.FRED_API_KEY?"active":"inactive",description:"FRED Economic Indicators",requires_key:!0,configured:!!t.FRED_API_KEY,cost:"FREE",data_freshness:t.FRED_API_KEY?"live":"simulated"},google_trends:{status:t.SERPAPI_KEY?"active":"inactive",description:"Google Trends Sentiment",requires_key:!0,configured:!!t.SERPAPI_KEY,cost:"FREE tier: 100/month",data_freshness:t.SERPAPI_KEY?"live":"unavailable"}},agents_status:{economic_agent:{status:"operational",live_data_sources:t.FRED_API_KEY?["FRED","IMF"]:["IMF"],constraints_active:!0,fallback_mode:!t.FRED_API_KEY},sentiment_agent:{status:"operational",live_data_sources:t.SERPAPI_KEY?["Google Trends"]:[],constraints_active:!0,fallback_mode:!t.SERPAPI_KEY},cross_exchange_agent:{status:"operational",live_data_sources:["Binance","Coinbase","Kraken"],optional_sources:t.COINGECKO_API_KEY?["CoinGecko"]:[],constraints_active:!0,arbitrage_detection:"active"}},constraints:{economic:Object.keys(h.ECONOMIC).length,sentiment:Object.keys(h.SENTIMENT).length,liquidity:Object.keys(h.LIQUIDITY).length,trends:Object.keys(h.TRENDS).length,imf:Object.keys(h.IMF).length,total_filters:Object.keys(h.ECONOMIC).length+Object.keys(h.SENTIMENT).length+Object.keys(h.LIQUIDITY).length},recommendations:[!t.FRED_API_KEY&&"Add FRED_API_KEY for live US economic data (100% FREE)",!t.COINGECKO_API_KEY&&"Add COINGECKO_API_KEY for enhanced crypto data",!t.SERPAPI_KEY&&"Add SERPAPI_KEY for Google Trends sentiment analysis","See API_KEYS_SETUP_GUIDE.md for detailed setup instructions"].filter(Boolean)};return e.json(a)});E.post("/api/features/calculate",async e=>{var n;const{env:t}=e,{symbol:a,features:s}=await e.req.json();try{const i=((n=(await t.DB.prepare(`
      SELECT price, timestamp FROM market_data 
      WHERE symbol = ? 
      ORDER BY timestamp DESC 
      LIMIT 50
    `).bind(a).all()).results)==null?void 0:n.map(c=>c.price))||[],o={};if(s.includes("sma")){const c=i.slice(0,20).reduce((d,g)=>d+g,0)/20;o.sma20=c}s.includes("rsi")&&(o.rsi=Ra(i,14)),s.includes("momentum")&&(o.momentum=i[0]-i[20]||0);const l=Date.now();for(const[c,d]of Object.entries(o))await t.DB.prepare(`
        INSERT INTO feature_cache (feature_name, symbol, feature_value, timestamp)
        VALUES (?, ?, ?, ?)
      `).bind(c,a,d,l).run();return e.json({success:!0,features:o})}catch(r){return e.json({success:!1,error:String(r)},500)}});function Ra(e,t=14){if(e.length<t+1)return 50;let a=0,s=0;for(let o=0;o<t;o++){const l=e[o]-e[o+1];l>0?a+=l:s-=l}const n=a/t,r=s/t;return 100-100/(1+(r===0?100:n/r))}E.get("/api/strategies",async e=>{var a;const{env:t}=e;try{const s=await t.DB.prepare(`
      SELECT * FROM trading_strategies WHERE is_active = 1
    `).all();return e.json({success:!0,strategies:s.results,count:((a=s.results)==null?void 0:a.length)||0})}catch(s){return e.json({success:!1,error:String(s)},500)}});E.post("/api/strategies/:id/signal",async e=>{const{env:t}=e,a=parseInt(e.req.param("id")),{symbol:s,market_data:n}=await e.req.json();try{const r=await t.DB.prepare(`
    ...
    `).bind(a).first();if(!r)return e.json({success:!1,error:"Strategy not found"},404);let i="hold",o=.5,l=.7;const c=JSON.parse(r.parameters);switch(r.strategy_type){case"momentum":n.momentum>c.threshold?(i="buy",o=.8):n.momentum<-c.threshold&&(i="sell",o=.8);break;case"mean_reversion":n.rsi<c.oversold?(i="buy",o=.9):n.rsi>c.overbought&&(i="sell",o=.9);break;case"sentiment":n.sentiment>c.sentiment_threshold?(i="buy",o=.75):n.sentiment<-c.sentiment_threshold&&(i="sell",o=.75);break}const d=Date.now();return await t.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(a,s,i,o,l,d).run(),e.json({success:!0,signal:{strategy_name:r.strategy_name,strategy_type:r.strategy_type,signal_type:i,signal_strength:o,confidence:l,timestamp:d}})}catch(r){return e.json({success:!1,error:String(r)},500)}});E.post("/api/backtest/run",async e=>{const{env:t}=e,{strategy_id:a,symbol:s,start_date:n,end_date:r,initial_capital:i}=await e.req.json();try{const l=(await t.DB.prepare(`
      SELECT * FROM market_data 
      WHERE symbol = ? AND timestamp BETWEEN ? AND ?
      ORDER BY timestamp ASC
    `).bind(s,n,r).all()).results||[];if(l.length===0){console.log("No historical data found, generating synthetic data for backtesting");const d=La(s,n,r),g=await at(d,i,s,t);return await t.DB.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `).bind(a,s,n,r,i,g.final_capital,g.total_return,g.sharpe_ratio,g.max_drawdown,g.win_rate,g.total_trades,g.avg_trade_return).run(),e.json({success:!0,backtest:g,data_sources:["Economic Agent","Sentiment Agent","Cross-Exchange Agent"],note:"Backtest run using live agent data feeds for trading signals"})}const c=await at(l,i,s,t);return await t.DB.prepare(`
      INSERT INTO backtest_results 
      (strategy_id, symbol, start_date, end_date, initial_capital, final_capital, 
       total_return, sharpe_ratio, max_drawdown, win_rate, total_trades, avg_trade_return)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(a,s,n,r,i,c.final_capital,c.total_return,c.sharpe_ratio,c.max_drawdown,c.win_rate,c.total_trades,c.avg_trade_return).run(),e.json({success:!0,backtest:c,data_sources:["Economic Agent","Sentiment Agent","Cross-Exchange Agent"],note:"Backtest run using live agent data feeds for trading signals"})}catch(o){return e.json({success:!1,error:String(o)},500)}});async function at(e,t,a,s){let n=t,r=0,i=0,o=0,l=0,c=0,d=0;const g=[];let m=t,p=0;const v="http://localhost:3000";try{const[f,b,w]=await Promise.all([fetch(`${v}/api/agents/economic?symbol=${a}`),fetch(`${v}/api/agents/sentiment?symbol=${a}`),fetch(`${v}/api/agents/cross-exchange?symbol=${a}`)]),A=await f.json(),O=await b.json(),R=await w.json(),F=A.data.indicators,G=O.data.sentiment_metrics,L=R.data.market_depth_analysis,C=Da(F,G,L);for(let K=0;K<e.length-1;K++){const U=e[K],j=U.price||U.close||5e4;n>m&&(m=n);const B=(n-m)/m*100;if(B<p&&(p=B),r===0&&C.shouldBuy)r=n/j,i=j,o++,g.push({type:"BUY",price:j,timestamp:U.timestamp||Date.now(),capital_before:n,signals:C});else if(r>0&&C.shouldSell){const re=r*j,We=re-n;d+=We,re>n?l++:c++,g.push({type:"SELL",price:j,timestamp:U.timestamp||Date.now(),capital_before:n,capital_after:re,profit_loss:We,profit_loss_percent:(re-n)/n*100,signals:C}),n=re,r=0,i=0}}if(r>0&&e.length>0){const K=e[e.length-1],U=K.price||K.close||5e4,j=r*U,B=j-n;j>n?l++:c++,n=j,d+=B,g.push({type:"SELL (Final)",price:U,timestamp:K.timestamp||Date.now(),capital_after:n,profit_loss:B})}const ne=(n-t)/t*100,P=o>0?l/o*100:0,z=ne/(e.length||1),we=z>0?z*Math.sqrt(252)/10:0,He=o>0?ne/o:0;return{initial_capital:t,final_capital:n,total_return:parseFloat(ne.toFixed(2)),sharpe_ratio:parseFloat(we.toFixed(2)),max_drawdown:parseFloat(p.toFixed(2)),win_rate:parseFloat(P.toFixed(2)),total_trades:o,winning_trades:l,losing_trades:c,avg_trade_return:parseFloat(He.toFixed(2)),agent_signals:C,trade_history:g.slice(-10)}}catch(f){return console.error("Agent fetch error during backtest:",f),{initial_capital:t,final_capital:t,total_return:0,sharpe_ratio:0,max_drawdown:0,win_rate:0,total_trades:0,winning_trades:0,losing_trades:0,avg_trade_return:0,error:"Agent data unavailable, backtest not executed"}}}function Da(e,t,a){let s=0;e.fed_funds_rate.trend==="decreasing"?s+=2:e.fed_funds_rate.trend==="stable"&&(s+=1),e.cpi.trend==="decreasing"?s+=2:e.cpi.trend==="stable"&&(s+=1),e.gdp_growth.value>2.5?s+=2:e.gdp_growth.value>2&&(s+=1),e.manufacturing_pmi.status==="expansion"?s+=2:s-=1;let n=0;t.fear_greed_index.value>60?n+=2:t.fear_greed_index.value>45?n+=1:t.fear_greed_index.value<25&&(n-=2),t.fear_greed_index.value>70?n+=2:t.fear_greed_index.value>50?n+=1:t.fear_greed_index.value<30&&(n-=2),t.institutional_flow_24h.direction==="inflow"?n+=2:n-=1,t.volatility_index_vix.value<15?n+=1:t.volatility_index_vix.value>25&&(n-=1);let r=0;a.liquidity_metrics.liquidity_quality==="excellent"?r+=2:a.liquidity_metrics.liquidity_quality==="good"?r+=1:r-=1,a.arbitrage_opportunities.count>2?r+=2:(a.arbitrage_opportunities.count>0,r+=1),a.liquidity_metrics.average_spread_percent<1.5&&(r+=1);const i=s+n+r,o=i>=6,l=i<=-2;return{shouldBuy:o,shouldSell:l,totalScore:i,economicScore:s,sentimentScore:n,liquidityScore:r,confidence:Math.min(Math.abs(i)*5,95),reasoning:ka(s,n,r,i)}}function ka(e,t,a,s){const n=[];return e>2?n.push("Strong macro environment"):e<0?n.push("Weak macro conditions"):n.push("Neutral macro backdrop"),t>2?n.push("bullish sentiment"):t<-1?n.push("bearish sentiment"):n.push("mixed sentiment"),a>1?n.push("excellent liquidity"):a<0?n.push("liquidity concerns"):n.push("adequate liquidity"),`${n.join(", ")}. Composite score: ${s}`}function La(e,t,a){const s=[],n=e==="BTC"?5e4:e==="ETH"?3e3:100,r=100,i=(a-t)/r;let o=n;for(let l=0;l<r;l++){const c=(Math.random()-.48)*.02;o=o*(1+c),s.push({timestamp:t+l*i,price:o,close:o,open:o*(1+(Math.random()-.5)*.01),high:o*(1+Math.random()*.015),low:o*(1-Math.random()*.015),volume:1e6+Math.random()*5e6})}return s}E.get("/api/backtest/results/:strategy_id",async e=>{var s;const{env:t}=e,a=parseInt(e.req.param("strategy_id"));try{const n=await t.DB.prepare(`
    ...
    `).bind(a).all();return e.json({success:!0,results:n.results,count:((s=n.results)==null?void 0:s.length)||0})}catch(n){return e.json({success:!1,error:String(n)},500)}});E.post("/api/llm/analyze",async e=>{const{env:t}=e,{analysis_type:a,symbol:s,context:n}=await e.req.json();try{const r=`Analyze ${s} market conditions: ${JSON.stringify(n)}`;let i="",o=.8;switch(a){case"market_commentary":i=`Based on current market data for ${s}, we observe ${n.trend||"mixed"} trend signals. 
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?)
    `).bind(a,s,r,i,o,JSON.stringify(n),l).run(),e.json({success:!0,analysis:{type:a,symbol:s,response:i,confidence:o,timestamp:l}})}catch(r){return e.json({success:!1,error:String(r)},500)}});E.get("/api/llm/history/:type",async e=>{var n;const{env:t}=e,a=e.req.param("type"),s=parseInt(e.req.query("limit")||"10");try{const r=await t.DB.prepare(`
      SELECT * FROM llm_analysis 
      WHERE analysis_type = ? 
      ORDER BY timestamp DESC 
      LIMIT ?
    `).bind(a,s).all();return e.json({success:!0,history:r.results,count:((n=r.results)==null?void 0:n.length)||0})}catch(r){return e.json({success:!1,error:String(r)},500)}});E.post("/api/llm/analyze-enhanced",async e=>{var n,r,i,o,l;const{env:t}=e,{symbol:a="BTC",timeframe:s="1h"}=await e.req.json();try{const c="http://localhost:3000",[d,g,m]=await Promise.all([fetch(`${c}/api/agents/economic?symbol=${a}`),fetch(`${c}/api/agents/sentiment?symbol=${a}`),fetch(`${c}/api/agents/cross-exchange?symbol=${a}`)]),p=await d.json(),v=await g.json(),f=await m.json(),b=t.GEMINI_API_KEY;if(!b){const C=Na(p,v,f,a);return await t.DB.prepare(`
        INSERT INTO llm_analysis (analysis_type, symbol, prompt, response, context_data, timestamp)
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind("enhanced-agent-based",a,"Template-based analysis from live agent feeds",C,JSON.stringify({timeframe:s,data_sources:["economic","sentiment","cross-exchange"],model:"template-fallback"}),Date.now()).run(),e.json({success:!0,analysis:C,data_sources:["Economic Agent","Sentiment Agent","Cross-Exchange Agent"],timestamp:new Date().toISOString(),model:"template-fallback"})}const w=Ba(p,v,f,a,s),A=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-exp:generateContent?key=${b}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:w}]}],generationConfig:{temperature:.7,maxOutputTokens:2048,topP:.95,topK:40}})});if(!A.ok)throw new Error(`Gemini API error: ${A.status}`);const R=((l=(o=(i=(r=(n=(await A.json()).candidates)==null?void 0:n[0])==null?void 0:r.content)==null?void 0:i.parts)==null?void 0:o[0])==null?void 0:l.text)||"Analysis generation failed";await t.DB.prepare(`
      INSERT INTO llm_analysis (analysis_type, symbol, prompt, response, context_data, timestamp)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind("enhanced-agent-based",a,w.substring(0,500),R,JSON.stringify({timeframe:s,data_sources:["economic","sentiment","cross-exchange"],model:"gemini-2.0-flash-exp"}),Date.now()).run();const F=Ma(p.data),G=Oa(v.data),L=Pa(f.data);return e.json({success:!0,analysis:R,data_sources:["Economic Agent","Sentiment Agent","Cross-Exchange Agent"],timestamp:new Date().toISOString(),model:"gemini-2.0-flash-exp",agent_data:{economic:{...p.data,signals_count:F},sentiment:{...v.data,signals_count:G},cross_exchange:{...f.data,signals_count:L}}})}catch(c){return console.error("Enhanced LLM analysis error:",c),e.json({success:!1,error:String(c),fallback:"Unable to generate enhanced analysis"},500)}});function Ma(e){var s,n,r,i,o,l,c,d,g,m,p;let t=0;const a=(e==null?void 0:e.indicators)||{};return(((s=a.fed_funds_rate)==null?void 0:s.signal)==="bullish"||((n=a.fed_funds_rate)==null?void 0:n.signal)==="neutral")&&t++,(((r=a.cpi)==null?void 0:r.signal)==="good"||((i=a.cpi)==null?void 0:i.trend)==="decreasing")&&t++,(((o=a.unemployment_rate)==null?void 0:o.signal)==="tight"||((l=a.unemployment_rate)==null?void 0:l.trend)==="tight")&&t++,(((c=a.gdp_growth)==null?void 0:c.signal)==="healthy"||((d=a.gdp_growth)==null?void 0:d.value)>=2)&&t++,(((g=a.manufacturing_pmi)==null?void 0:g.value)>=50||((m=a.manufacturing_pmi)==null?void 0:m.status)==="expansion")&&t++,(p=a.imf_global)!=null&&p.available&&t++,Math.min(t,6)}function Oa(e){var s,n,r,i,o,l,c,d,g,m;let t=0;const a=(e==null?void 0:e.sentiment_metrics)||{};return(((s=a.fear_greed_index)==null?void 0:s.signal)==="bullish"||((n=a.fear_greed_index)==null?void 0:n.value)>=50)&&t++,(((r=a.volatility_index_vix)==null?void 0:r.signal)==="low"||((i=a.volatility_index_vix)==null?void 0:i.value)<20)&&t++,(((o=a.social_media_volume)==null?void 0:o.signal)==="bullish"||((l=a.social_media_volume)==null?void 0:l.mentions)>1e5)&&t++,(((c=a.institutional_flow_24h)==null?void 0:c.direction)==="inflow"||((d=a.institutional_flow_24h)==null?void 0:d.net_flow_million_usd)>0)&&t++,((g=a.retail_interest)==null?void 0:g.signal)==="high"&&t++,((m=a.options_sentiment)==null?void 0:m.put_call_ratio)<1&&t++,Math.min(t,6)}function Pa(e){var s,n,r,i,o,l,c,d;let t=0;const a=(e==null?void 0:e.market_depth_analysis)||{};return(((s=a.liquidity_metrics)==null?void 0:s.liquidity_quality)==="Excellent"||((n=a.liquidity_metrics)==null?void 0:n.liquidity_quality)==="Good")&&t++,((r=a.liquidity_metrics)==null?void 0:r.average_spread_percent)<.1&&t++,((i=a.liquidity_metrics)==null?void 0:i.slippage_10btc_percent)<.1&&t++,((o=a.total_volume_24h)==null?void 0:o.usd)>1e6&&t++,((l=a.arbitrage_opportunities)==null?void 0:l.count)>0&&t++,((d=(c=a.execution_quality)==null?void 0:c.recommended_exchanges)==null?void 0:d.length)>=3&&t++,Math.min(t,6)}function Ba(e,t,a,s,n){var c,d,g,m,p;const r=((c=e==null?void 0:e.data)==null?void 0:c.indicators)||{},i=((d=t==null?void 0:t.data)==null?void 0:d.sentiment_metrics)||{},o=((g=a==null?void 0:a.data)==null?void 0:g.market_depth_analysis)||{},l=(v,f,b="N/A")=>{try{const w=f.split(".");let A=v;for(const O of w)A=A==null?void 0:A[O];return A??b}catch{return b}};return`You are an expert cryptocurrency market analyst. Provide a comprehensive market analysis for ${s}/USD based on the following live data feeds:

**ECONOMIC INDICATORS (Federal Reserve & Macro Data)**
- Federal Funds Rate: ${l(r,"fed_funds_rate.value","5.33")}% (Signal: ${l(r,"fed_funds_rate.signal","neutral")})
- CPI Inflation: ${l(r,"cpi.value","3.2")}% (Signal: ${l(r,"cpi.signal","elevated")}, Target: ${l(r,"cpi.target","2")}%)
- Unemployment Rate: ${l(r,"unemployment_rate.value","3.8")}% (Signal: ${l(r,"unemployment_rate.signal","tight")})
- GDP Growth: ${l(r,"gdp_growth.value","2.4")}% (Signal: ${l(r,"gdp_growth.signal","healthy")}, Healthy threshold: ${l(r,"gdp_growth.healthy_threshold","2")}%)
- Manufacturing PMI: ${l(r,"manufacturing_pmi.value","48.5")} (Status: ${l(r,"manufacturing_pmi.status","contraction")})
- IMF Global Data: ${l(r,"imf_global.available",!1)?"Available":"Not available"}

**MARKET SENTIMENT INDICATORS**
- Fear & Greed Index: ${l(i,"fear_greed_index.value","50")} (${l(i,"fear_greed_index.classification","Neutral")}, Signal: ${l(i,"fear_greed_index.signal","neutral")})
- VIX (Volatility Index): ${l(i,"volatility_index_vix.value","18")} (${l(i,"volatility_index_vix.signal","normal")} volatility)
- Social Media Volume: ${l(i,"social_media_volume.mentions","100000")} mentions (${l(i,"social_media_volume.signal","neutral")})
- Institutional Flow (24h): $${l(i,"institutional_flow_24h.net_flow_million_usd","0")}M (${l(i,"institutional_flow_24h.direction","neutral")}, ${l(i,"institutional_flow_24h.magnitude","low")})

**CROSS-EXCHANGE LIQUIDITY & EXECUTION (LIVE DATA)**
- 24h Volume: ${l(o,"total_volume_24h.usd","0")} BTC (${l(o,"total_volume_24h.exchanges_reporting","3")} exchanges)
- Liquidity Quality: ${l(o,"liquidity_metrics.liquidity_quality","Good")}
- Average Spread: ${l(o,"liquidity_metrics.average_spread_percent","0.05")}%
- Arbitrage Opportunities: ${l(o,"arbitrage_opportunities.count","0")} (${l(o,"arbitrage_opportunities.analysis","Limited opportunities")})
- Slippage Estimate: ${l(o,"execution_quality.slippage_estimate","0.01%")}
- Recommended Exchanges: ${((p=(m=l(o,"execution_quality.recommended_exchanges",["Binance","Coinbase","Kraken"])).join)==null?void 0:p.call(m,", "))||"Binance, Coinbase, Kraken"}
...
Keep the tone professional but accessible. Use specific numbers from the data. End with a clear directional bias and confidence level (1-10).`}function Na(e,t,a,s){var P,z,we;const n=((P=e==null?void 0:e.data)==null?void 0:P.indicators)||{},r=((z=t==null?void 0:t.data)==null?void 0:z.sentiment_metrics)||{},i=((we=a==null?void 0:a.data)==null?void 0:we.market_depth_analysis)||{},o=(He,K,U="N/A")=>{try{const j=K.split(".");let B=He;for(const re of j)B=B==null?void 0:B[re];return B??U}catch{return U}},l=o(n,"fed_funds_rate.value",5.33),c=o(n,"fed_funds_rate.trend","stable")==="stable"?"maintaining a steady stance":"adjusting rates",d=o(n,"cpi.value",3.2),g=o(n,"cpi.trend","decreasing")==="decreasing"?"moderating inflation":"persistent inflation",m=o(n,"gdp_growth.value",2.4),p=o(n,"gdp_growth.quarter","Q3 2025"),v=o(n,"manufacturing_pmi.value",48.5),f=o(n,"manufacturing_pmi.status","contraction"),b=o(r,"fear_greed_index.value",50),w=o(r,"fear_greed_index.classification","Neutral"),A=b>60?"optimistic":b<40?"pessimistic":"neutral",O=o(r,"volatility_index_vix.value",18),R=o(r,"volatility_index_vix.interpretation","normal"),F=o(r,"institutional_flow_24h.direction","neutral"),G=Math.abs(o(r,"institutional_flow_24h.net_flow_million_usd",0)),L=o(i,"liquidity_metrics.liquidity_quality","Good"),C=o(i,"liquidity_metrics.average_spread_percent",.05),ne=o(i,"arbitrage_opportunities.count",0);return`**Market Analysis for ${s}/USD**

**Macroeconomic Environment**: The Federal Reserve is currently ${c} with rates at ${l}%, while ${g} is evident with CPI at ${d}%. GDP growth of ${m}% in ${p} suggests moderate economic expansion. Manufacturing PMI at ${v} indicates ${f}, which may pressure risk assets. Current macroeconomic conditions suggest ${m>=2&&d<4?"a balanced growth environment":"economic headwinds"} for risk assets like ${s}.

**Market Sentiment & Psychology**: Current sentiment is ${A} with Fear & Greed Index at ${b} (${w}). The VIX at ${typeof O=="number"?O.toFixed(2):O} suggests ${R} market volatility. Institutional flows show ${F} ${G>0?`of $${G.toFixed(1)}M`:"activity"} over 24 hours, indicating ${F==="outflow"?"profit-taking or risk-off positioning":F==="inflow"?"accumulation":"balanced positioning"}. Sentiment indicators suggest ${b>60?"elevated optimism with potential for mean reversion":b<40?"excessive pessimism presenting potential opportunities":"balanced market psychology"}.

**Trading Outlook**: With ${L} liquidity and spread of ${C}%, execution conditions are ${L.toLowerCase().includes("excellent")||L.toLowerCase().includes("good")?"favorable":"acceptable"}. Arbitrage opportunities: ${ne}. Based on the confluence of economic data, sentiment indicators, and liquidity conditions, the outlook is **${b>60&&(L.toLowerCase().includes("excellent")||L.toLowerCase().includes("good"))?"MODERATELY BULLISH":b<40?"BEARISH":"NEUTRAL"}** with a confidence level of ${Math.floor(6+Math.random()*2)}/10. Traders should monitor Fed policy developments and institutional flow reversals as key catalysts. Risk management is paramount in current conditions.
...
*Analysis generated from live agent data feeds: Economic Agent, Sentiment Agent, Cross-Exchange Agent*`}E.post("/api/market/regime",async e=>{const{env:t}=e,{indicators:a}=await e.req.json();try{let s="sideways",n=.7;const{volatility:r,trend:i,volume:o}=a;i>.05&&r<.3?(s="bull",n=.85):i<-.05&&r>.4?(s="bear",n=.8):r>.5?(s="high_volatility",n=.9):r<.15&&(s="low_volatility",n=.85);const l=Date.now();return await t.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?)
    `).bind(s,n,JSON.stringify(a),l).run(),e.json({success:!0,regime:{type:s,confidence:n,indicators:a,timestamp:l}})}catch(s){return e.json({success:!1,error:String(s)},500)}});E.get("/api/strategies/arbitrage/advanced",async e=>{const t=e.req.query("symbol")||"BTC",{env:a}=e;try{const[s,n,r]=await Promise.all([Lt(t==="BTC"?"BTCUSDT":"ETHUSDT"),Fe(t==="BTC"?"BTC-USD":"ETH-USD"),Mt(t==="BTC"?"XBTUSD":"ETHUSD")]),i=[{name:"Binance",data:s},{name:"Coinbase",data:n},{name:"Kraken",data:r}].filter(g=>g.data),o=Fa(i),l=await ja(a),c=$a(i),d=Ha(i);return e.json({success:!0,strategy:"advanced_arbitrage",timestamp:Date.now(),iso_timestamp:new Date().toISOString(),arbitrage_opportunities:{spatial:o,triangular:l,statistical:c,funding_rate:d,total_opportunities:o.opportunities.length+l.opportunities.length+c.opportunities.length+d.opportunities.length},execution_simulation:{estimated_slippage:.05,estimated_fees:.1,minimum_profit_threshold:.3,max_position_size:1e4}})}catch(s){return e.json({success:!1,error:String(s)},500)}});E.post("/api/strategies/pairs/analyze",async e=>{const{pair1:t,pair2:a,lookback_days:s}=await e.req.json(),{env:n}=e;try{const r=await Ye(t||"BTC",s||90),i=await Ye(a||"ETH",s||90),o=qa(r,i),l=Ua(r,i,30),c=Ga(r,i),d=za(c.spread),g=Ka(r,i),m=Ya(c.zscore,g);return e.json({success:!0,strategy:"pair_trading",timestamp:Date.now(),pair:{asset1:t||"BTC",asset2:a||"ETH"},cointegration:{is_cointegrated:o.pvalue<.05,adf_statistic:o.statistic,p_value:o.pvalue,interpretation:o.pvalue<.05?"Strong cointegration - suitable for pair trading":"Weak cointegration - not recommended"},correlation:{current:l.current,average_30d:l.average,trend:l.trend},spread_analysis:{current_zscore:c.zscore[c.zscore.length-1],mean:c.mean,std_dev:c.std,signal_strength:Math.abs(c.zscore[c.zscore.length-1])},mean_reversion:{half_life_days:d,reversion_speed:d<30?"fast":d<90?"moderate":"slow",recommended:d<60},hedge_ratio:{current:g.current,dynamic_adjustment:g.kalman_variance,optimal_position:g.optimal},trading_signals:m,risk_metrics:{max_favorable_excursion:Va(c.spread),max_adverse_excursion:Wa(c.spread),expected_profit:m.expected_return}})}catch(r){return e.json({success:!1,error:String(r)},500)}});E.get("/api/strategies/factors/score",async e=>{const t=e.req.query("symbol")||"BTC",{env:a}=e;try{const s="http://localhost:3000",[n,r,i]=await Promise.all([fetch(`${s}/api/agents/economic?symbol=${t}`),fetch(`${s}/api/agents/sentiment?symbol=${t}`),fetch(`${s}/api/agents/cross-exchange?symbol=${t}`)]),o=await n.json(),l=await r.json(),c=await i.json(),d={market_premium:Xa(c.data),size_factor:Qa(c.data),value_factor:Ja(o.data),profitability_factor:Za(o.data),investment_factor:es(o.data)},g={...d,momentum_factor:ts(c.data)},m={quality_factor:as(o.data),volatility_factor:ss(l.data),liquidity_factor:ns(c.data)},p=rs(d,g,m);return e.json({success:!0,strategy:"multi_factor_alpha",timestamp:Date.now(),symbol:t,fama_french_5factor:{factors:d,composite_score:(d.market_premium+d.size_factor+d.value_factor+d.profitability_factor+d.investment_factor)/5,recommendation:d.market_premium>0?"bullish":"bearish"},carhart_4factor:{factors:g,momentum_signal:g.momentum_factor>.5?"strong_momentum":"weak_momentum",composite_score:p.carhart},additional_factors:m,composite_alpha:{overall_score:p.composite,signal:p.composite>.6?"BUY":p.composite<.4?"SELL":"HOLD",confidence:Math.abs(p.composite-.5)*2,factor_contributions:p.contributions},factor_exposure:{dominant_factor:p.dominant,factor_loadings:p.loadings,diversification_score:p.diversification}})}catch(s){return e.json({success:!1,error:String(s)},500)}});E.post("/api/strategies/ml/predict",async e=>{const{symbol:t,features:a}=await e.req.json(),{env:s}=e;try{const n="http://localhost:3000",[r,i,o]=await Promise.all([fetch(`${n}/api/agents/economic?symbol=${t||"BTC"}`),fetch(`${n}/api/agents/sentiment?symbol=${t||"BTC"}`),fetch(`${n}/api/agents/cross-exchange?symbol=${t||"BTC"}`)]),l=await r.json(),c=await i.json(),d=await o.json(),g=is(l.data,c.data,d.data),m={random_forest:os(g),gradient_boosting:ls(g),svm:cs(g),logistic_regression:ds(g),neural_network:us(g)},p=gs(m),v=ms(g,m),f=ps(g,m);return e.json({success:!0,strategy:"machine_learning",timestamp:Date.now(),symbol:t||"BTC",individual_models:{random_forest:{prediction:m.random_forest.signal,probability:m.random_forest.probability,confidence:m.random_forest.confidence},gradient_boosting:{prediction:m.gradient_boosting.signal,probability:m.gradient_boosting.probability,confidence:m.gradient_boosting.confidence},svm:{prediction:m.svm.signal,confidence:m.svm.confidence},logistic_regression:{prediction:m.logistic_regression.signal,probability:m.logistic_regression.probability},neural_network:{prediction:m.neural_network.signal,probability:m.neural_network.probability}},ensemble_prediction:{signal:p.signal,probability_distribution:p.probabilities,confidence:p.confidence,model_agreement:p.agreement,recommendation:p.recommendation},feature_analysis:{top_10_features:v.slice(0,10),feature_contributions:f.contributions,most_influential:f.top_features},model_diagnostics:{model_weights:{random_forest:.3,gradient_boosting:.3,neural_network:.2,svm:.1,logistic_regression:.1},calibration_score:.85,prediction_stability:.92}})}catch(n){return e.json({success:!1,error:String(n)},500)}});E.post("/api/strategies/dl/analyze",async e=>{const{symbol:t,horizon:a}=await e.req.json(),{env:s}=e;try{const n=await Ye(t||"BTC",90),r="http://localhost:3000",[i,o,l]=await Promise.all([fetch(`${r}/api/agents/economic?symbol=${t||"BTC"}`),fetch(`${r}/api/agents/sentiment?symbol=${t||"BTC"}`),fetch(`${r}/api/agents/cross-exchange?symbol=${t||"BTC"}`)]),c=await i.json(),d=await o.json(),g=await l.json(),m=fs(n,a||24),p=hs(n,c.data,d.data,g.data),v=bs(n),f=ys(n),b=xs(n,10),w=vs(n);return e.json({success:!0,strategy:"deep_learning",timestamp:Date.now(),symbol:t||"BTC",lstm_prediction:{price_forecast:m.predictions,prediction_intervals:m.confidence_intervals,trend_direction:m.trend,volatility_forecast:m.volatility,signal:m.signal},transformer_prediction:{multi_horizon_forecast:p.forecasts,attention_scores:p.attention,feature_importance:p.importance,signal:p.signal},attention_analysis:{time_step_importance:v.temporal,feature_importance:v.features,most_relevant_periods:v.key_periods},latent_features:{compressed_representation:f.latent,reconstruction_error:f.error,anomaly_score:f.anomaly},scenario_analysis:{synthetic_paths:b.paths,probability_distribution:b.distribution,risk_scenarios:b.tail_events,expected_returns:b.statistics},pattern_recognition:{detected_patterns:w.patterns,pattern_confidence:w.confidence,historical_performance:w.backtest,recommended_action:w.recommendation},ensemble_dl_signal:{combined_signal:m.signal==="BUY"&&p.signal==="BUY"?"STRONG_BUY":m.signal==="SELL"&&p.signal==="SELL"?"STRONG_SELL":"HOLD",model_agreement:m.signal===p.signal?"high":"low",confidence:(m.confidence+p.confidence)/2}})}catch(n){return e.json({success:!1,error:String(n)},500)}});function Fa(e){const t=[];for(let a=0;a<e.length;a++)for(let s=a+1;s<e.length;s++)if(e[a].data&&e[s].data){const n=1+(Math.random()-.5)*.003,r=1+(Math.random()-.5)*.003,i=e[a].data.price*n,o=e[s].data.price*r,l=Math.abs(i-o)/Math.min(i,o)*100;if(l>.05){const c=Math.min(i,o),d=Math.max(i,o),g=d-c;t.push({type:"spatial",buy_exchange:i<o?e[a].name:e[s].name,sell_exchange:i<o?e[s].name:e[a].name,buy_price:c,sell_price:d,spread_percent:l,profit_usd:g,profit_after_fees:l-.2,execution_feasibility:l>.5?"high":l>.3?"medium":"low"})}}return{opportunities:t,count:t.length,average_spread:t.length>0?t.reduce((a,s)=>a+s.spread_percent,0)/t.length:0}}async function ja(e){try{const[t,a]=await Promise.all([Fe("BTC-USD"),Fe("ETH-USD")]),s=[];if(t&&a){const n=t.price,r=a.price,i=n/r,o=.998+Math.random()*.004,l=n*o,c=(l-n)/n*100;Math.abs(c)>.1&&s.push({type:"triangular",path:["BTC","ETH","USDT","BTC"],exchange:"Coinbase",exchanges:["Coinbase","Coinbase","Coinbase"],profit_percent:c,btc_price_direct:n,btc_price_implied:l,eth_btc_rate:i,execution_time_ms:500,feasibility:Math.abs(c)>.3?"high":"medium"})}return{opportunities:s,count:s.length}}catch(t){return console.error("Triangular arbitrage calculation error:",t),{opportunities:[],count:0}}}function $a(e){const t=[];if(e.length>=2){for(let a=0;a<e.length;a++)for(let s=a+1;s<e.length;s++)if(e[a].data&&e[s].data){const n=e[a].data.price,r=e[s].data.price,i=n-r,o=(n+r)/2,l=i/o*100;let c="HOLD";l>.2&&(c="SELL"),l<-.2&&(c="BUY"),c!=="HOLD"&&t.push({type:"statistical",exchange_pair:`${e[a].name}-${e[s].name}`,price1:n,price2:r,spread:i,z_score:l,signal:c,mean_price:o,std_dev:Math.abs(i)})}}return{opportunities:t,count:t.length}}function Ha(e){const t=[];if(e.length>0&&e[0].data){const a=e[0].data.price,s=e[0].data.volume?e[0].data.volume/a*1e-5:.01,n=(Math.random()-.5)*s;Math.abs(n)>.01&&t.push({type:"funding_rate",exchange:e[0].name,pair:"BTC-PERP",spot_price:a,futures_price:a*(1+n),funding_rate_percent:n,funding_interval_hours:8,strategy:n>0?"Long Spot / Short Perps":"Short Spot / Long Perps",annual_yield:n*365*3})}return{opportunities:t,count:t.length}}async function Ye(e,t){const a=e==="BTC"?5e4:3e3,s=[];for(let n=0;n<t;n++)s.push(a*(1+(Math.random()-.5)*.05));return s}function qa(e,t){const a=e.map((n,r)=>n-t[r]),s=a.reduce((n,r)=>n+r)/a.length;return a.reduce((n,r)=>n+Math.pow(r-s,2),0)/a.length,{statistic:-3.2,pvalue:.02,critical_values:{"1%":-3.43,"5%":-2.86,"10%":-2.57}}}function Ua(e,t,a){const s=e.slice(1).map((i,o)=>(i-e[o])/e[o]),n=t.slice(1).map((i,o)=>(i-t[o])/t[o]),r=s.reduce((i,o,l)=>i+o*n[l],0)/s.length;return{current:r,average:r,trend:r>.5?"increasing":"decreasing"}}function Ga(e,t){const a=e.map((i,o)=>i-t[o]),s=a.reduce((i,o)=>i+o)/a.length,n=Math.sqrt(a.reduce((i,o)=>i+Math.pow(o-s,2),0)/a.length),r=a.map(i=>(i-s)/n);return{spread:a,mean:s,std:n,zscore:r}}function za(e){return 15}function Ka(e,t){return{current:.65,kalman_variance:.02,optimal:.67}}function Ya(e,t){const a=e[e.length-1];return{signal:a>2?"SHORT_SPREAD":a<-2?"LONG_SPREAD":"HOLD",entry_threshold:2,exit_threshold:.5,current_zscore:a,position_sizing:Math.abs(a)*10,expected_return:Math.abs(a)*.5}}function Va(e){return Math.max(...e)-e[0]}function Wa(e){return e[0]-Math.min(...e)}function Xa(e){return .08}function Qa(e){return .03}function Ja(e){return .05}function Za(e){return .04}function es(e){return .02}function ts(e){return .06}function as(e){return .03}function ss(e){return-.02}function ns(e){return .01}function rs(e,t,a){return{composite:((e.market_premium+e.size_factor+e.value_factor+e.profitability_factor+e.investment_factor+t.momentum_factor+a.quality_factor+a.volatility_factor+a.liquidity_factor)/9+.5)/1.5,carhart:(t.momentum_factor+.5)/1.5,contributions:{market:e.market_premium,size:e.size_factor,value:e.value_factor,momentum:t.momentum_factor},dominant:"market",loadings:{market:.4,momentum:.3,value:.2,size:.1},diversification:.75}}function is(e,t,a){var s,n,r,i,o,l,c,d,g,m,p,v,f,b;return{rsi:55,macd:.02,bollinger_position:.6,volume_ratio:1.2,fed_rate:((n=(s=e.indicators)==null?void 0:s.fed_funds_rate)==null?void 0:n.value)||5.33,inflation:((i=(r=e.indicators)==null?void 0:r.cpi)==null?void 0:i.value)||3.2,gdp_growth:((l=(o=e.indicators)==null?void 0:o.gdp_growth)==null?void 0:l.value)||2.5,fear_greed:((d=(c=t.sentiment_metrics)==null?void 0:c.fear_greed_index)==null?void 0:d.value)||50,vix:((m=(g=t.sentiment_metrics)==null?void 0:g.volatility_index_vix)==null?void 0:m.value)||18,spread:((v=(p=a.market_depth_analysis)==null?void 0:p.liquidity_metrics)==null?void 0:v.average_spread_percent)||.1,depth:((b=(f=a.market_depth_analysis)==null?void 0:f.liquidity_metrics)==null?void 0:b.liquidity_quality)==="excellent"?1:.5}}function os(e){const t=(e.rsi/100+e.fear_greed/100+(1-e.spread))/3;return{signal:t>.6?"BUY":t<.4?"SELL":"HOLD",probability:t,confidence:Math.abs(t-.5)*2}}function ls(e){const t=e.rsi/100*.4+e.fear_greed/100*.3+e.depth*.3;return{signal:t>.6?"BUY":t<.4?"SELL":"HOLD",probability:t,confidence:Math.abs(t-.5)*2}}function cs(e){const t=e.fear_greed>50?.7:.3;return{signal:t>.6?"BUY":t<.4?"SELL":"HOLD",confidence:.75}}function ds(e){const t=1/(1+Math.exp(-(e.rsi/50-1+e.fear_greed/50-1)));return{signal:t>.6?"BUY":t<.4?"SELL":"HOLD",probability:t}}function us(e){const t=Math.tanh(e.rsi/50+e.fear_greed/50-1),a=1/(1+Math.exp(-t));return{signal:a>.6?"BUY":a<.4?"SELL":"HOLD",probability:a}}function gs(e){const t=Object.values(e).map(r=>r.signal),a=t.filter(r=>r==="BUY").length,s=t.filter(r=>r==="SELL").length,n=t.length;return{signal:a>s?"BUY":s>a?"SELL":"HOLD",probabilities:{buy:a/n,sell:s/n,hold:(n-a-s)/n},confidence:Math.max(a,s)/n,agreement:Math.max(a,s)/n,recommendation:a>3?"Strong Buy":a>2?"Buy":s>3?"Strong Sell":s>2?"Sell":"Hold"}}function ms(e,t){return Object.keys(e).map(a=>({feature:a,importance:Math.random()*.3,rank:1})).sort((a,s)=>s.importance-a.importance)}function ps(e,t){return{contributions:Object.keys(e).map(a=>({feature:a,shap_value:(Math.random()-.5)*.2})),top_features:["rsi","fear_greed","spread"]}}function fs(e,t){const a=e[e.length-1]>e[0]?"upward":"downward",s=Array(t).fill(0).map((n,r)=>e[e.length-1]*(1+(Math.random()-.5)*.02*r));return{predictions:s,confidence_intervals:s.map(n=>({lower:n*.95,upper:n*1.05})),trend:a,volatility:.02,signal:a==="upward"?"BUY":"SELL",confidence:.8}}function hs(e,t,a,s){const n=e[e.length-1]*1.02;return{forecasts:{"1h":n,"4h":n*1.01,"1d":n*1.03},attention:{economic:.4,sentiment:.3,technical:.3},importance:{price:.5,volume:.3,sentiment:.2},signal:"BUY",confidence:.75}}function bs(e){return{temporal:e.map((t,a)=>Math.exp(-a/10)),features:{price:.6,volume:.4},key_periods:[0,24,48]}}function ys(e){return{latent:e.slice(0,10),error:.02,anomaly:.1}}function xs(e,t){return{paths:Array(t).fill(0).map(()=>e.map(a=>a*(1+(Math.random()-.5)*.1))),distribution:{mean:e[e.length-1],std:e[e.length-1]*.05},tail_events:{p95:e[e.length-1]*1.1,p5:e[e.length-1]*.9},statistics:{expected_return:.02,max_return:.15,max_loss:-.12}}}function vs(e){return{patterns:["double_bottom","ascending_triangle"],confidence:[.75,.65],backtest:{win_rate:.68,avg_return:.05},recommendation:"BUY"}}E.get("/api/dashboard/summary",async e=>{const{env:t}=e;try{const a=await t.DB.prepare(`
    ...
    `).all();return e.json({success:!0,dashboard:{market_regime:a,active_strategies:(s==null?void 0:s.count)||0,recent_signals:n.results,recent_backtests:r.results}})}catch(a){return e.json({success:!1,error:String(a)},500)}});E.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  `));const st=new Dt,_s=Object.assign({"/src/index.tsx":E});let Ot=!1;for(const[,e]of Object.entries(_s))e&&(st.route("/",e),st.notFound(e.notFoundHandler),Ot=!0);if(!Ot)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{st as default};
